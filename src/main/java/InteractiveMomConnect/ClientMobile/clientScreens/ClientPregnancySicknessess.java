...
public class ClientPregnancySicknessess extends  JFrame implements ActionListener {
    ...
    private JLabel pregSickLB;
    private JSeparator exerciseSeparator;
    private JTextArea exerciseTA;
    // End of variables declaration

    public ClientPregnancySicknessess() {
        initComponents();
    }

    private void initComponents() {

        pregSickLB = new JLabel();
        ...
        pregSickLB.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        pregSickLB.setText("Pregnancy Sicknesses");
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(115, 115, 115)
                                                .addComponent(pregSickLB, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(73, 73, 73)
    ...
    private void chatIconBTActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientPregnancySicknessess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
